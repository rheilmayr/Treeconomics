...
kd <- kde2d(x = site_summary$cwd.ave, y = site_summary$pet.ave, n = 25, lims = c(c(0,750),c(100, 600)))
points(site_summary$cwd.ave, site_summary$pet.ave)
...
grandmodel <- lm(estimate~cwd.ave+I(cwd.ave^2) + I(cwd.ave^3) + pet.ave + I(pet.ave^2) + I(pet.ave^3),weights=errorweights,data= dat)
